    ...
    <div className="my-20 mx-4 md:mx-[80px]">
      <div className="mb-10">
        ...
        <div className=" md:flex md:justify-between">
          ...
          <div className="text-white hidden gap-[40px] md:flex md:cursor-pointer">
            <svg
      ...
      <div className=" mt-20 mx-auto md:flex gap-4 md:justify-between">
        <div className="relative ">
          <img
            className="w-full h-[450px] rounded-2xl mx-auto "
        ...
        <div className="relative hidden md:flex">
          <img
            className="w-full h-[450px] rounded-2xl items-center "
        ...
        <div className="relative hidden lg:flex">
          <img
            className="w-full h-[450px] rounded-2xl items-center sm:hidden md:flex"
