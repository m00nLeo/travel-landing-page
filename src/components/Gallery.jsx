    ...
    <div className="my-20 mx-4 md:mx-[80px]">
      <div className="mb-10">
        ...
        <div className="md:flex md:justify-between">
          ...
          <div className="text-white gap-2 md:cursor-pointer hidden md:flex">
            <svg
      ...
      <div className="lg:flex gap-4 py-2 ">
        <img
          className="w-full h-[400px] object-cover rounded-2xl items-center my-8"
        ...
        />
        <img
          className="w-full h-[400px] object-cover rounded-2xl items-center my-4"
